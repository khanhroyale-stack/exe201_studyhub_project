...
import com.management.studyhub.repository.specification.CourseSpecification;
...
public class CourseServiceImpl implements CourseService {
    ...
    @Override
    public List<CourseDto> getAllCourses(String keyword, String subjects, String grades, Double maxPrice, String method) {
        Specification<Course> spec = CourseSpecification.getCoursesByFilters(keyword, subjects, grades, maxPrice, method);
